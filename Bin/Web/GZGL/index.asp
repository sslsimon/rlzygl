...
<table width="100%" height="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
  <tr>
    <td align="center" valign="middle"><table width="380" border="0" cellpadding="0" cellspacing="1">
			<tr>
				<td width="336" height="25" align="center" ><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; [工资查询系统]</strong></td>
			</tr>
		</table>
							...
							<tr>
								<td valign="top"><table width="60" height="8" border="0" align="center" cellpadding="0" cellspacing="0">
										...
										<table width="265" height="24" border="0" align="center" cellpadding="0" cellspacing="0">
											<tr>
											  <td width="89"><div align="right">身份证号：</div></td>
										      <td width="176"><input name="username" type="text" class="S-T-12" id="username" size="20" maxlength="20"></td>
											</tr>
								  </table>
									...
									<table width="281" height="16" border="0" align="center" cellpadding="0" cellspacing="0">
											<tr>
