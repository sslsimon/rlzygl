...
'       strUnit     ----计数单位
'***********************************************
sub showpage(sfilename,totalnumber,maxperpage,ShowTotal,ShowAllPages,strUnit,select_tine)
	...
	'strTemp=strTemp & "<input name='select_t' type='text' value='"&select_tine&"'/>"   
	...
	strUrl=JoinChar(sfilename)
  	if CurrentPage<2 then
    		...
    		strTemp=strTemp & "<a href='" & strUrl & "page=1"&"&select_t="&select_tine&"'>首页</a>&nbsp;"
    		strTemp=strTemp & "<a href='" & strUrl & "page=" & (CurrentPage-1) & ""&"&select_t="&select_tine&" '>上一页</a>&nbsp;"
  	end if
%>
...
<%	
  	...
  	if n-currentpage<1 then
    		...
    		strTemp=strTemp & "<a href='" & strUrl & "page=" & (CurrentPage+1) & ""&"&select_t="&select_tine&"'>下一页</a>&nbsp;"
    		strTemp=strTemp & "<a href='" & strUrl & "page=" & n & ""&"&select_t="&select_tine&"'>尾页</a>"
  	end if
