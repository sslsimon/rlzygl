...
<form name="form1" method="post" action="qry_htgl_qyjf.asp">
过滤条件：请输入“甲方名称“ 。如果为空，则显示所有合同&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="qry_select.asp" ><strong>返回查询选择页</strong></a><br>
甲方名称 =
...
if name <> "" then
	sqll=sqll & " where  QYJF like '%" & name & "%' "
end if
